...
urlpatterns = patterns('',
    ...
    url(r'^burndown_chart_por_sprint/(?P<pk>\d+)$$', views.burndown_chart_sprint, name='burndown_chart_sprint'),
    url(r'^burndown_chart_sprint_list/(?P<pk>\d+)$$', login_required(views.BurndownSprintList.as_view()), name='burndown_chart_sprint_list'),
)
